...
def get_answer(query):
    messages = [
        {"role": "system", "content": "You're Kiran, an AI bot with in-depth knowledge of Indian law and government, equipped to answer related queries succinctly. Answer in 2 sentences."},
          ]
    if query:
      messages.append(
...
def page5(ans):
    ...
    payload = {
        ...
        "source_url": "https://res.cloudinary.com/dz1lt2wwz/image/upload/v1686441257/1_lwiw6i.png"
    }
    ...
    output_url = dict_data['result_url']    
    print(output_url)
    #st.video(output_url,width=320, height=180)
    # Create columns
...
def add_bg_from_url():
    st.markdown(
         ...
         <style>
         .stApp {{
             background-image: url("https://res.cloudinary.com/dz1lt2wwz/image/upload/v1686459140/WhatsApp_Image_2023-06-11_at_10.22.02_AM_qqqgdl.jpg ");
...
query = st.text_input(label="", value="",key='input-box',placeholder="Ask questions like - what is alimony?", args=('input-box',))
