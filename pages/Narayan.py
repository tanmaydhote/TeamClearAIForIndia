...
def get_answer(query):
    messages = [
        {"role": "system", "content": "You're Narayan, a finance-savvy AI bot tasked with providing concise money-saving and investment advice in the Indian context."},
          ]
    if query:
      messages.append(
...
def add_bg_from_url():
    st.markdown(
         ...
         <style>
         .stApp {{
             background-image: url("https://res.cloudinary.com/dz1lt2wwz/image/upload/v1686461269/WhatsApp_Image_2023-06-11_at_10.56.41_AM_pxim0c.jpg");
...
query = st.text_input(label="", value="",key='input-box',placeholder="Ask questions like - when is the right time to start investing?", args=('input-box',))
