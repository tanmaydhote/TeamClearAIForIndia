...
def get_answer(query):
    messages = [
        {"role": "system", "content": "You're Mary, a globally recognized AI bot in Indian cuisine, responsible for offering short, clear guidance on recipes, healthy eating, and food-related inquiries."},
          ]
    if query:
      messages.append(
...
def page5(ans):
    ...
    payload = {
        ...
        "source_url": "https://res.cloudinary.com/dz1lt2wwz/image/upload/v1686463325/Narayan_200_200_px_250_250_px_2_ff9vfz.png"
    }
...
def add_bg_from_url():
    st.markdown(
         ...
         <style>
         .stApp {{
             background-image: url("https://res.cloudinary.com/dz1lt2wwz/image/upload/v1686461475/WhatsApp_Image_2023-06-11_at_10.56.41_AM_2_fs9crb.jpg");
...
query = st.text_input(label="", value="",key='input-box',placeholder="Ask questions like - recipe for paneer tikka", args=('input-box',))
